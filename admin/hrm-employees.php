...
<div class="admin-content">
    <div class="page-header stf-page-head">
        ...
        <div class="d-flex gap-2">
          <a class="btn-coop btn-outline" href="hrm-dashboard.php"><i class="fas fa-gauge-high"></i> ड्यासबोर्ड</a>
  ...
  <div class="card-coop stf-modal-card stf-modal-card-lg" style="max-width:880px;width:96%;">
    ...
    <form method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
      ...
      <div class="row g-2">
        ...
        <div class="col-md-3"><label class="small">जन्म मिति (BS)</label><input class="field-coop" name="dob_bs" id="f_dob_bs" placeholder="2058-04-12"></div>
        ...
        <div class="col-md-4"><label class="small">स्थायी जिल्ला/नगर/वडा</label>
          <div class="d-flex gap-1">
            <input class="field-coop" name="perm_district" id="f_pdist" placeholder="जिल्ला">
            <input class="field-coop" name="perm_municipality" id="f_pmun" placeholder="न.पा./गा.पा.">
        ...
        <div class="col-md-2"><label class="small">नियुक्ति (BS)</label><input class="field-coop" name="join_date_bs" id="f_jdbs"></div>
