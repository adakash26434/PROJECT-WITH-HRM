    ...
    <?php if (false): ?>
        <div class="midx-ds-grid">
                ...
                <a href="<?php echo htmlspecialchars($ds['href']); ?>"
                   <?php if (!empty($ds['target'])): ?>target="<?php echo htmlspecialchars($ds['target'], ENT_QUOTES); ?>" rel="noopener"<?php endif; ?>
                   class="midx-ds-card midx-ds-card-bg" style="--midx-ds-bg:<?php echo htmlspecialchars($ds['bg'], ENT_QUOTES, 'UTF-8'); ?>;">
                    <div class="midx-ds-icon-wrap midx-ds-icon-bg" style="--midx-ds-color:<?php echo htmlspecialchars($ds['color'], ENT_QUOTES, 'UTF-8'); ?>;">
                        <i class="<?php echo htmlspecialchars($ds['iconLib'] ?? 'fas', ENT_QUOTES); ?> <?php echo htmlspecialchars($ds['icon'], ENT_QUOTES); ?> midx-ds-icon"></i>
                    </div>
                    <div class="midx-ds-label"><?php echo htmlspecialchars($ds['label']); ?></div>
                    <div class="midx-ds-desc"><?php echo htmlspecialchars($ds['desc']); ?></div>
                </a>
                <?php endforeach; ?>
            </div>
    <?php endif; ?>
    ...
    <div class="mem-grid-2 midx-grid-2" id="recent-apps">
        ...
        <div class="mem-card">
            ...
            <div class="mem-card-body midx-body-pad-sm">
                ...
                ?>
                <div class="mem-notif-item midx-notif-item <?php echo !$n['is_read'] ? 'unread' : ''; ?>" onclick="markRead(<?php echo (int)$n['id']; ?>, this)">
