...
CSS;
        ...
        echo '<!DOCTYPE html><html lang="ne"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
            ...
            . '<link rel="stylesheet" href="' . $baseUrlH . 'assets/css/design-tokens.css?v=5">'
            . $brandDynamicStyle
            . '<link rel="stylesheet" href="' . $baseUrlH . 'assets/css/coop-core.css?v=1.0">'
            . '<link rel="stylesheet" href="' . $baseUrlH . 'assets/css/unified-portal.css?v=2.0">'
            . '<link rel="stylesheet" href="' . $baseUrlH . 'assets/css/theme-overrides-v4.css?v=' . (@filemtime((defined('ROOT_PATH') ? ROOT_PATH : '') . 'assets/css/theme-overrides-v4.css') ?: '4.0') . '">'
            . $layoutCss
