...
if (!isset($statColClass)) $statColClass = 'col-6 col-sm-6 col-lg-4 col-xl-2';
...
<div class="<?php echo $statColClass; ?>">
    <<?php echo $_tag; ?><?php echo $_href; ?> class="stat-card stat-card-flat stat-card-compact d-flex align-items-center gap-2 p-2 rounded-2 text-decoration-none h-100"
        ...
        <div class="stat-card-body flex-grow-1 min-w-0">
