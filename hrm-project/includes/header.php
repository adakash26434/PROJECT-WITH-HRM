...
<head>
    ...
    <!-- Custom CSS (legacy public layout — preserved) -->
    <link rel="stylesheet" href="<?php echo SITE_URL; ?>assets/css/style.css?v=<?php echo @filemtime(__DIR__ . '/../assets/css/style.css') ?: '1'; ?>">
    <!-- 🎨 Design Tokens — brand colors, spacing, typography variables -->
    <link rel="stylesheet" href="<?php echo SITE_URL; ?>assets/css/design-tokens.css?v=5">
    <?php @require_once __DIR__ . '/../assets/css/global-theme.php'; ?>
    <!-- ✅ Coop Core — unified design system v1.0
         Replaces: universal.css, global-unify-v2.css, ui-uniformity-fix.css,
                   v9-mobile-fix.css, v10.6-mobile-audit.css, site-banner-logo.css -->
    <link rel="stylesheet" href="<?php echo SITE_URL; ?>assets/css/coop-core.css?v=1.0">
    <link rel="stylesheet" href="<?php echo SITE_URL; ?>assets/css/coop-clean.css?v=6.5">
    <!-- Header v2 — public portal header/nav/drawer styles -->
    <link rel="stylesheet" href="<?php echo SITE_URL; ?>assets/css/header-v2.css?v=24">
      <!-- ✅ Unified System v2.0 — shared base + components + UI fixes -->
      <link rel="stylesheet" href="<?php echo SITE_URL; ?>assets/css/unified-portal.css?v=2.0">
      <link rel="stylesheet" href="<?php echo SITE_URL; ?>assets/css/components.css?v=2.0">
      <link rel="stylesheet" href="<?php echo SITE_URL; ?>assets/css/ui-fixes.css?v=1.0">
      <!-- 🎨 Final theme fixes: loaded last so cPanel/live pages actually receive fixes -->
      <link rel="stylesheet" href="<?php echo SITE_URL; ?>assets/css/public-modern.css?v=<?php echo @filemtime(__DIR__ . '/../assets/css/public-modern.css') ?: '5'; ?>">
      <link rel="stylesheet" href="<?php echo SITE_URL; ?>assets/css/theme-overrides-v3.css?v=<?php echo @filemtime(__DIR__ . '/../assets/css/theme-overrides-v3.css') ?: '3.0'; ?>">
      <link rel="stylesheet" href="<?php echo SITE_URL; ?>assets/css/theme-overrides-v4.css?v=<?php echo @filemtime(__DIR__ . '/../assets/css/theme-overrides-v4.css') ?: '4.0'; ?>">
