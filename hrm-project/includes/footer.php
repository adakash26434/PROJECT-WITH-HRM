...
<!-- v11.5 — legacy public-fab-help removed (now inside qh-launcher) -->
<!-- v11.4 — Unified Quick-Help Launcher (collapses WhatsApp/Help/Chat/Links) -->
<div class="qh-launcher" id="qhLauncher" aria-label="Quick Help">
  <div class="qh-menu" role="menu">
    ...
    <button type="button" class="qh-item" role="menuitem"
      ...
      <span class="qh-ic help"><i class="fas fa-question"></i></span>
      <span>सहायता / FAQ</span>
    </button>
    <?php if (!empty($usefulLinks)): ?>
    <button type="button" class="qh-item" role="menuitem"
      onclick="var t=document.getElementById('usefulLinksToggle');if(t)t.click();document.getElementById('qhLauncher').classList.remove('open');">
      <span class="qh-ic links"><i class="fas fa-external-link-alt"></i></span>
      <span>उपयोगी लिंकहरू</span>
    </button>
    <?php endif; ?>
  </div>
  <button type="button" class="qh-fab" id="qhFab" aria-label="Quick Help"
    onclick="document.getElementById('qhLauncher').classList.toggle('open');">
    <i class="fas fa-headset qh-i-open"></i>
