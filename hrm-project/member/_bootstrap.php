...
if (!function_exists('memberHeadAssets')) {
    function memberHeadAssets(): void {
        ...
        echo '<link rel="stylesheet" href="' . htmlspecialchars($base, ENT_QUOTES) . 'assets/css/theme-overrides-v4.css?v=' . (@filemtime(__DIR__ . '/../assets/css/theme-overrides-v4.css') ?: '4.0') . '">' . "\n";
