...
<!-- 🎨 Design Tokens + dynamic brand colors (shared with public/admin) -->
<link rel="stylesheet" href="<?php echo $_siteUrl; ?>assets/css/design-tokens.css?v=5">
<?php @require_once __DIR__ . '/../../assets/css/global-theme.php'; ?>
<!-- ✅ Coop Core — unified design system v1.0
     Replaces: global-unify-v2.css, eye-candy-v7.css, site-banner-logo.css -->
<link rel="stylesheet" href="<?php echo $_siteUrl; ?>assets/css/coop-core.css?v=1.0">
<link rel="stylesheet" href="<?php echo $_siteUrl; ?>assets/css/coop-clean.css?v=6.5">
