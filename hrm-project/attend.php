...
<link rel="stylesheet" href="<?= htmlspecialchars(SITE_URL) ?>assets/css/unified-portal.css?v=2.0">
<link rel="stylesheet" href="<?= htmlspecialchars(SITE_URL) ?>assets/css/design-tokens.css?v=1">
<link rel="stylesheet" href="<?= htmlspecialchars(SITE_URL) ?>assets/css/public-modern.css?v=5">
