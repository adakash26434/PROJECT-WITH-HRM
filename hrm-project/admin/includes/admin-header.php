...
<head>
    ...
    <!-- 🎨 Design Tokens + Admin tokens overlay -->
    ...
    <!-- ✅ Coop Core — unified design system v1.0
         Replaces: global-unify-v2.css, v9-mobile-fix.css, site-banner-logo.css -->
    <link rel="stylesheet" href="../assets/css/coop-core.css?v=1.0">

    <!-- Admin CSS (layout + modern overlay + mobile) -->
    <link rel="stylesheet" href="assets/admin.css?v=9.7">
    <link rel="stylesheet" href="assets/admin-modern.css?v=6.5">
    <link rel="stylesheet" href="../assets/css/admin-mobile.css?v=6.5">
    <!-- ✅ Clean design discipline — no gradients, no hover-lift, soft shadows -->
    <link rel="stylesheet" href="../assets/css/coop-clean.css?v=6.5">
      <!-- ✅ Unified System v2.0 — shared base + components + UI fixes -->
      <link rel="stylesheet" href="../assets/css/unified-portal.css?v=2.0">
      <link rel="stylesheet" href="../assets/css/components.css?v=2.0">
      <link rel="stylesheet" href="../assets/css/ui-fixes.css?v=1.0">
      <link rel="stylesheet" href="../assets/css/theme-overrides-v3.css?v=<?php echo @filemtime(__DIR__ . '/../../assets/css/theme-overrides-v3.css') ?: '3.0'; ?>">
      <link rel="stylesheet" href="../assets/css/theme-overrides-v4.css?v=<?php echo @filemtime(__DIR__ . '/../../assets/css/theme-overrides-v4.css') ?: '4.0'; ?>">
                ...
                <div class="header-right">
                    ...
                    <div class="header-item">
                        <div class="admin-info">
                            ...
                            <span class="admin-last-login-badge" title="<?php echo $adminT('अघिल्लो लगइन', 'Previous login'); ?>: <?php echo htmlspecialchars(date('Y-m-d H:i:s', $ts)); ?>">
                                <i class="fas fa-clock"></i>
                                <?php echo $adminT('अघिल्लो', 'Last login'); ?>: <?php echo htmlspecialchars($adminLastLoginLabel); ?>
                            </span>
                            <?php endif; ?>
