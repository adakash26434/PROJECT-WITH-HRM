...
<link rel="stylesheet" href="<?php echo htmlspecialchars(SITE_URL); ?>assets/css/unified-portal.css?v=2.0">
<link rel="stylesheet" href="<?php echo htmlspecialchars(SITE_URL); ?>assets/css/design-tokens.css?v=1">
<link rel="stylesheet" href="<?php echo htmlspecialchars(SITE_URL); ?>assets/css/public-modern.css?v=5">
...
<link rel="stylesheet" href="<?php echo htmlspecialchars(SITE_URL); ?>assets/css/theme-overrides-v4.css?v=<?php echo @filemtime(__DIR__ . '/assets/css/theme-overrides-v4.css') ?: '4.0'; ?>">
<script>
